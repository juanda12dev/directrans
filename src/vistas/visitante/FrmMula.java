...
import vistas.visitante.*;
import static vistas.visitante.FrmPpalVisitantes.FondoVisit;

public class FrmMula extends javax.swing.JFrame {
    ...
    public FrmMula() {
        ...
        this.PintarImagenLBL(this.imgMULA, "src/img/mula.png");
    }
    ...
    private void initComponents() {
        ...
        imgMULA = new javax.swing.JLabel();
        ...
        setTitle("SERVICIO DE TRACTOMULAS");
        setIconImage(getIconImage());

        PanlFurgon.setBackground(new java.awt.Color(24, 106, 240));

        imgMULA.setPreferredSize(new java.awt.Dimension(250, 160));

        jLabel1.setFont(new java.awt.Font("Centaur", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("TRACTOMULAS PARA SERVICIO INTERNACIONAL");
        ...
        PanlFurgonLayout.setHorizontalGroup(
            ...
            .addGroup(PanlFurgonLayout.createSequentialGroup()
                ...
                .addContainerGap())
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PanlFurgonLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(imgMULA, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(374, 374, 374))
            .addGroup(PanlFurgonLayout.createSequentialGroup()
                .addGroup(PanlFurgonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(PanlFurgonLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 609, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, PanlFurgonLayout.createSequentialGroup()
                        .addGap(195, 195, 195)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMula.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel imgMULA;
