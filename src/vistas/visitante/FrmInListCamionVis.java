...
public class FrmInListCamionVis extends javax.swing.JInternalFrame {

    public static String v;

    public FrmInListCamionVis() {
        initComponents();
        listarCamion();
        v = "v";
...
//************************************************************************************************************************************  
    ...
    private void initComponents() {
        ...
        tablaCamionesVisit = new javax.swing.JTable();
        ...
        tablaCamionesVisit.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tablaCamionesVisit);
...
//*****************************************************LISTAR DATOS SUCURSAL*******************************************************
    public void listarCamion() {
        try {
            ...
            tablaCamionesVisit.setModel(modelo);
            ...
            String sql = "SELECT placa,capacidad,marca,tipo,servicios,estado FROM  camiones";
    ...
    private javax.swing.JTable tablaCamionesVisit;
