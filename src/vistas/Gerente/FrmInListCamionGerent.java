...
public class FrmInListCamionGerent extends javax.swing.JInternalFrame {

    public static String c;

    public FrmInListCamionGerent() {
        initComponents();
        listarCamion();
        c = "c";
...
//************************************************************************************************************************************
    ...
    private void initComponents() {
        ...
        tablaCamionesg = new javax.swing.JTable();
        ...
        tablaCamionesg.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tablaCamionesg);
...
//*****************************************************LISTAR DATOS SUCURSAL*******************************************************
    public void listarCamion() {
        try {
            ...
            tablaCamionesg.setModel(modelo);
            ...
            String sql = "SELECT codigo,placa,capacidad,marca,tipo,nom_pro,tel_pro,servicios,estado FROM  camiones";
    ...
    private javax.swing.JTable tablaCamionesg;
